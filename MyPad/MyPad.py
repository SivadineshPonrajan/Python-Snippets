# -*- coding: utf-8 -*-
"""
Created on Thu Jun  7 13:09:58 2018
...
class Notepad:
    ...
    __thisMoreMenu = Menu(__thisMenuBar, tearoff=0)
    ...
    def __init__(self,**kwargs):
        ...
        self.__thisMoreMenu.add_command(label="About MyPad",
                                        command=self.__showAbout) 
        self.__thisMenuBar.add_cascade(label="More",
                                       menu=self.__thisMoreMenu)
    ...
    def __showAbout(self):
        showinfo("MyPad","MyPad is a text editor developed by Sivadinesh using Python")
    ...
    def SaveChangesDialog(self):
        if self.__thisTextArea.edit_modified():
            result = messagebox.askquestion("MyPad","Do you want to save changes to the document?")
            if result =='yes':
                self.__saveFile()
     #           self.__thisTextArea.edit_modified()=0
                return 1
            return 0
